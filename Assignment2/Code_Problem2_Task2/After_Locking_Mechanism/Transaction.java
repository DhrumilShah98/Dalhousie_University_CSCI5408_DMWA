...
public class Transaction implements Runnable {
    ...
    public void run() {
        ...
        try (final Connection connection = DriverManager.getConnection(
            ...
            // WRITE exclusive lock applied.
            statement.execute(DatabaseConstants.applyWriteLockToCustomersTable());
            ...
            // WRITE exclusive lock released.
            statement.execute(DatabaseConstants.unlockCustomerTable());
    ...
    private static final class DatabaseConstants {
        ...
        private static String applyWriteLockToCustomersTable() {
            return "LOCK TABLES olist_customers_dataset WRITE;";
        }

        private static String unlockCustomerTable() {
